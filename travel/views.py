...
def travel_finance(request, travelplan_id):
    ...
    expenses_grouped = expenses_type.values('typeexpense_id__nametypeexpense').annotate(full_amount=Sum('full_amount'))

    # Подсчет общей стоимости всех расходов
    total_expenses = expenses_type.aggregate(total=Sum('full_amount'))['total']
    ...
    expenses_data = [
    {
        ...
        'percentage': round(float(e['full_amount'] / total_expenses * 100), 2) if total_expenses > 0 else 0
    }
    ...
    total_amount_1 = expenses_1.aggregate(total=Sum('full_amount'))['total'] or 0    
    ...
    total_amount_2 = expenses_2.aggregate(total=Sum('full_amount'))['total'] or 0
    try:
    ...
    total_amount_3 = expenses_3.aggregate(total=Sum('full_amount'))['total'] or 0
    ...
    total_amount_4 = expenses_4.aggregate(total=Sum('full_amount'))['total'] or 0
    ...
    total_amount_5 = expenses_5.aggregate(total=Sum('full_amount'))['total'] or 0
    ...
    total_amount_6 = expenses_6.aggregate(total=Sum('full_amount'))['total'] or 0
    ...
    total_amount_7 = expenses_7.aggregate(total=Sum('full_amount'))['total'] or 0
    ...
    total_amount_8 = expenses_8.aggregate(total=Sum('full_amount'))['total'] or 0
    ...
    total_amount_9 = expenses_9.aggregate(total=Sum('full_amount'))['total'] or 0
    ...
    total_amount_10 = expenses_10.aggregate(total=Sum('full_amount'))['total'] or 0
    ...
    total_amount_11 = expenses_11.aggregate(total=Sum('full_amount'))['total'] or 0
    ...
    total_amount_12 = expenses_12.aggregate(total=Sum('full_amount'))['total'] or 0
